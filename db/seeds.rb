...
.id)
tesla1 = Car.create(make: "Tesla", model: "X", year: 2020, price: 40900, status: "new", customer_id: "Beza",  dealership_id: d2.id)
tesla2= Car.create(make: "Tesla", model: "X", year: 2020, price: 54000, status: "new", customer_id:"bob",  dealership_id: d2.id)
...
honda = Car.create(make: "Honda", model: "Accord", year: 2013, price: 700000, status: "Used",customer_id: "Danny", dealership_id: d2.id)
