...
.id)
tesla = Car.create(make: "Tesla", model: "X", year: 2020, price: 50000, status: "new", customer_id: beza.id, dealership_id: d2.id)
tesla = Car.create(make: "Tesla", model: "3", year: 2020, price: 50000, status: "new", dealership_id: d2.id)
...
honda = Car.create(make: "Honda", model: "Accord", year: 2013, price: 200000, status: "Used", customer_id: danny.id, dealership_id: d2.id)
